print('họ tên: TRAN VAN TRUNG; MSSV:245752021610133')
...
tk.Label(root, text="TRAN VAN TRUNG").grid(row=1, column=1, sticky="w")

tk.Label(root, text="Ngày sinh:").grid(row=2, column=0, sticky="w", padx=10, pady=5)
tk.Label(root, text="27/02/2006").grid(row=2, column=1, sticky="w")

tk.Label(root, text="MSSV:").grid(row=3, column=0, sticky="w", padx=10, pady=5)
tk.Label(root, text="245752021610133").grid(row=3, column=1, sticky="w")
